...
Si se analiza el contenido del CID final de la carpeta subida en el DAG:
...
\begin{figure}[H]
      ...
      \begin{tikzpicture}[node distance = 0.5cm, auto]
            ...
            \node [block] (mfs) {MFS \\ Sistema de archivos convencional};
            \node [block, below = of mfs] (unixfs) {UnixFS \\ Nodos de datos que modelan archivos y directorios};
            \node [block, below = of unixfs] (dag) {DAG \\ Datos estructurados en nodos};
            \node [block, below = of dag] (block) {Bloque \\ Datos binarios};
