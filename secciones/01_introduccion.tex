...
Sobre el alcance del proyecto, en el capitulo \ref{chap:6trabajosfuturos}: '\nameref{chap:6trabajosfuturos}' se explora las posibles vías de expansión y mejoras para el proyecto en el futuro. También se expresan las esperanzas y expectativas para el crecimiento y posible impacto del mismo.
...
El capítulo \ref{chap:3desarrollo}: '\nameref{chap:3desarrollo}' se centra en el desarrollo del sistema propuesto. Este se ha estructurado en en:
\begin{itemize}
...
En el capítulo \ref{chap:4evaluacion}: '\nameref{chap:4evaluacion}' se realiza una
...
El capítulo \ref{chap:5resultados}: '\nameref{chap:5resultados}' se analiza el resultado obtenido del desarrollo del proyecto. Se contrastará
el resultado con los objetivos propuestos y con servicios de transferencia de archivos centralizados.

En el capítulo \ref{chap:6trabajosfuturos}: '\nameref{chap:6trabajosfuturos}' se proponen posibles mejoras y ampliaciones del sistema propuesto.