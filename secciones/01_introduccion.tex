...
En el capítulo \ref{chap:2contexto}: '\nameref{chap:2contexto}' se explica brevemente la historia de internet y su evolución hasta el presente.
...
El capítulo \ref{chap:6resultados}: '\nameref{chap:6resultados}' se analiza el resultado obtenido del desarrollo del proyecto. Además, se 
